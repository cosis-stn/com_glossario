...
class GlossariocosisModelGlossrio extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        // Load the parameters.
        $params = JComponentHelper::getParams('com_glossariocosis');
        $this->setState('params', $params);

        // List state information.
        parent::populateState('a.termo', 'asc');
    }
    ...
    public function getItems() {
        ...
        foreach ($items as $oneItem) {
            ...
            if (isset($oneItem->manual)) {
                ...
                $title = GlossariocosisHelpersGlossariocosis::getGroupNameByGroupId($oneItem->manual);
