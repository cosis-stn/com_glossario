 ...
 * @since  1.6
 */
class GlossariocosisControllerGlossarios extends JControllerLegacy {
    ...
    public function edit() {
        ...
        // Get the model.
        $model = $this->getModel('Glossarios', 'GlossariocosisModel');
    ...
    public function publish() {
        ...
        if ($user->authorise('core.edit', 'com_glossariocosis') || $user->authorise('core.edit.state', 'com_glossariocosis')) {
            $model = $this->getModel('Glossarios', 'GlossariocosisModel');
            ...
            if (!$item) {
                ...
                $this->setRedirect(JRoute::_('index.php?option=com_glossariocosis&view=glossrio', false));
            } else {
    ...
    public function remove() {
        ...
        if ($user->authorise('core.delete', 'com_glossariocosis')) {
            $model = $this->getModel('Glossarios', 'GlossariocosisModel');
            ...
            if ($return === false) {
                ...
                $this->setMessage(JText::_('COM_GLOSSARIOCOSIS_ITEM_DELETED_SUCCESSFULLY'));
            }
